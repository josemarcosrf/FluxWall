...
def discover():
    discover_generators()
from fluxwall.generators.game_of_life import GameOfLifeGenerator
from fluxwall.generators.mandelbrot import MandelbrotGenerator
from fluxwall.generators.julia import JuliaGenerator
